...
//		patientRepository.save(new Patient(null, "Farah", new Date(),2500, true));
//		patientRepository.save(new Patient(null, "Imane", new Date(),1300, true));
//		patientRepository.save(new Patient(null, "Ahmed", new Date(),300, false));
		System.out.println("********************************************");
...
//		patientRepository.deleteById(5L);
		...
		Page<Patient> pagePatients = patientRepository.findAll(PageRequest.of(0, 2)); // Que 2 patients de la page 0 
